 ...
 */
    __pyx_v_c01 = (((__pyx_v_v_c[((__pyx_v_Y * __pyx_v_x0) + __pyx_v_y0)]) * (1.0 - __pyx_v_xd)) + ((__pyx_v_v_c[((__pyx_v_Y * __pyx_v_x1) + __pyx_v_y0)]) * __pyx_v_xd));

    /* "interp2d/interp2d.pyx":27
 *         c00 = v_c[Y*x0+y0]*(1-xd) + v_c[Y*x1+y0]*xd
 *         c01 = v_c[Y*x0+y0]*(1-xd) + v_c[Y*x1+y0]*xd
 *         c10 = v_c[Y*x0+y1]*(1-xd) + v_c[Y*x1+y1]*xd             # <<<<<<<<<<<<<<
 *         c11 = v_c[Y*x0+y1]*(1-xd) + v_c[Y*x1+y1]*xd
 ...
 *         c0 = c00*(1-yd) + c10*yd
 */
    __pyx_v_c11 = (((__pyx_v_v_c[((__pyx_v_Y * __pyx_v_x0) + __pyx_v_y1)]) * (1.0 - __pyx_v_xd)) + ((__pyx_v_v_c[((__pyx_v_Y * __pyx_v_x1) + __pyx_v_y1)]) * __pyx_v_xd));

    /* "interp2d/interp2d.pyx":30
 *         c11 = v_c[Y*x0+y1]*(1-xd) + v_c[Y*x1+y1]*xd
 * 
 *         c0 = c00*(1-yd) + c10*yd             # <<<<<<<<<<<<<<
 *         c1 = c01*(1-yd) + c11*yd
 ...
 *     else:
 */
    __pyx_v_c = ((__pyx_v_c0 + __pyx_v_c1) / 2.0);
