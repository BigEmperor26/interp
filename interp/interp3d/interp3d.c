...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "interp.interp3d.interp3d",
        "sources": [
            "interp/interp3d/interp3d.pyx"
        ]
    },
    "module_name": "interp.interp3d.interp3d"
}
END: Cython Metadata */
...
#define __PYX_HAVE__interp__interp3d__interp3d
#define __PYX_HAVE_API__interp__interp3d__interp3d
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'interp.interp3d.interp3d' */
...
static __pyx_t_5numpy_float_t __pyx_f_6interp_8interp3d_8interp3d__interp3D(__Pyx_memviewslice, __pyx_t_5numpy_float_t, __pyx_t_5numpy_float_t, __pyx_t_5numpy_float_t, int, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "interp.interp3d.interp3d"
extern int __pyx_module_is_main_interp__interp3d__interp3d;
int __pyx_module_is_main_interp__interp3d__interp3d = 0;

/* Implementation of 'interp.interp3d.interp3d' */
...
static PyObject *__pyx_n_s_y;
static PyObject *__pyx_n_s_z;
static PyObject *__pyx_pf_6interp_8interp3d_8interp3d__interp3D(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_v, __pyx_t_5numpy_float_t __pyx_v_x, __pyx_t_5numpy_float_t __pyx_v_y, __pyx_t_5numpy_float_t __pyx_v_z, int __pyx_v_X, int __pyx_v_Y, int __pyx_v_Z); /* proto */
...
/* "interp/interp3d/interp3d.pyx":7
 * 
 * @cdivision(True)
...
static PyObject *__pyx_pw_6interp_8interp3d_8interp3d_1_interp3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __pyx_t_5numpy_float_t __pyx_f_6interp_8interp3d_8interp3d__interp3D(__Pyx_memviewslice __pyx_v_v, __pyx_t_5numpy_float_t __pyx_v_x, __pyx_t_5numpy_float_t __pyx_v_y, __pyx_t_5numpy_float_t __pyx_v_z, int __pyx_v_X, int __pyx_v_Y, int __pyx_v_Z, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x0;
  int __pyx_v_x1;
  int __pyx_v_y0;
  int __pyx_v_y1;
  ...
  /* "interp/interp3d/interp3d.pyx":14
 *         np.float_t *v_c
 * 
 *     v_c = &v[0,0,0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":16
 *     v_c = &v[0,0,0]
 * 
 *     x0 = <int>floor(x)             # <<<<<<<<<<<<<<
 *     x1 = x0 + 1
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":17
 * 
 *     x0 = <int>floor(x)
 *     x1 = x0 + 1             # <<<<<<<<<<<<<<
 *     y0 = <int>floor(y)
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":18
 *     x0 = <int>floor(x)
 *     x1 = x0 + 1
 *     y0 = <int>floor(y)             # <<<<<<<<<<<<<<
 *     y1 = y0 + 1
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":19
 *     x1 = x0 + 1
 *     y0 = <int>floor(y)
 *     y1 = y0 + 1             # <<<<<<<<<<<<<<
 *     z0 = <int>floor(z)
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":20
 *     y0 = <int>floor(y)
 *     y1 = y0 + 1
 *     z0 = <int>floor(z)             # <<<<<<<<<<<<<<
 *     z1 = z0 + 1
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":21
 *     y1 = y0 + 1
 *     z0 = <int>floor(z)
 *     z1 = z0 + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":23
 *     z1 = z0 + 1
 * 
 *     xd = (x-x0)/(x1-x0)             # <<<<<<<<<<<<<<
 *     yd = (y-y0)/(y1-y0)
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":24
 * 
 *     xd = (x-x0)/(x1-x0)
 *     yd = (y-y0)/(y1-y0)             # <<<<<<<<<<<<<<
 *     zd = (z-z0)/(z1-z0)
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":25
 *     xd = (x-x0)/(x1-x0)
 *     yd = (y-y0)/(y1-y0)
 *     zd = (z-z0)/(z1-z0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":27
 *     zd = (z-z0)/(z1-z0)
 * 
 *     if x0 >= 0 and y0 >= 0 and z0 >= 0 and x1 < X and y1 < Y and z1 < Z:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    /* "interp/interp3d/interp3d.pyx":28
 * 
 *     if x0 >= 0 and y0 >= 0 and z0 >= 0 and x1 < X and y1 < Y and z1 < Z:
 *         c00 = v_c[Y*Z*x0+Z*y0+z0]*(1-xd) + v_c[Y*Z*x1+Z*y0+z0]*xd             # <<<<<<<<<<<<<<
 *         c01 = v_c[Y*Z*x0+Z*y0+z1]*(1-xd) + v_c[Y*Z*x1+Z*y0+z1]*xd
 ...
 */
    ...
    /* "interp/interp3d/interp3d.pyx":29
 *     if x0 >= 0 and y0 >= 0 and z0 >= 0 and x1 < X and y1 < Y and z1 < Z:
 *         c00 = v_c[Y*Z*x0+Z*y0+z0]*(1-xd) + v_c[Y*Z*x1+Z*y0+z0]*xd
 *         c01 = v_c[Y*Z*x0+Z*y0+z1]*(1-xd) + v_c[Y*Z*x1+Z*y0+z1]*xd             # <<<<<<<<<<<<<<
 *         c10 = v_c[Y*Z*x0+Z*y1+z0]*(1-xd) + v_c[Y*Z*x1+Z*y1+z0]*xd
 ...
 */
    ...
    /* "interp/interp3d/interp3d.pyx":30
 *         c00 = v_c[Y*Z*x0+Z*y0+z0]*(1-xd) + v_c[Y*Z*x1+Z*y0+z0]*xd
 *         c01 = v_c[Y*Z*x0+Z*y0+z1]*(1-xd) + v_c[Y*Z*x1+Z*y0+z1]*xd
 *         c10 = v_c[Y*Z*x0+Z*y1+z0]*(1-xd) + v_c[Y*Z*x1+Z*y1+z0]*xd             # <<<<<<<<<<<<<<
 *         c11 = v_c[Y*Z*x0+Z*y1+z1]*(1-xd) + v_c[Y*Z*x1+Z*y1+z1]*xd
 ...
 */
    ...
    /* "interp/interp3d/interp3d.pyx":31
 *         c01 = v_c[Y*Z*x0+Z*y0+z1]*(1-xd) + v_c[Y*Z*x1+Z*y0+z1]*xd
 *         c10 = v_c[Y*Z*x0+Z*y1+z0]*(1-xd) + v_c[Y*Z*x1+Z*y1+z0]*xd
 *         c11 = v_c[Y*Z*x0+Z*y1+z1]*(1-xd) + v_c[Y*Z*x1+Z*y1+z1]*xd             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "interp/interp3d/interp3d.pyx":33
 *         c11 = v_c[Y*Z*x0+Z*y1+z1]*(1-xd) + v_c[Y*Z*x1+Z*y1+z1]*xd
 * 
 *         c0 = c00*(1-yd) + c10*yd             # <<<<<<<<<<<<<<
 *         c1 = c01*(1-yd) + c11*yd
 ...
 */
    ...
    /* "interp/interp3d/interp3d.pyx":34
 * 
 *         c0 = c00*(1-yd) + c10*yd
 *         c1 = c01*(1-yd) + c11*yd             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "interp/interp3d/interp3d.pyx":36
 *         c1 = c01*(1-yd) + c11*yd
 * 
 *         c = c0*(1-zd) + c1*zd             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":39
 * 
 *     else:
 *         c = 0             # <<<<<<<<<<<<<<
 *     return c
 */
  ...
  /* "interp/interp3d/interp3d.pyx":40
 *     else:
 *         c = 0
 *     return c             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("interp.interp3d.interp3d._interp3D", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_6interp_8interp3d_8interp3d_1_interp3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6interp_8interp3d_8interp3d_1_interp3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("interp.interp3d.interp3d._interp3D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6interp_8interp3d_8interp3d__interp3D(__pyx_self, __pyx_v_v, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_X, __pyx_v_Y, __pyx_v_Z);
...
static PyObject *__pyx_pf_6interp_8interp3d_8interp3d__interp3D(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_v, __pyx_t_5numpy_float_t __pyx_v_x, __pyx_t_5numpy_float_t __pyx_v_y, __pyx_t_5numpy_float_t __pyx_v_z, int __pyx_v_X, int __pyx_v_Y, int __pyx_v_Z) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_6interp_8interp3d_8interp3d__interp3D(__pyx_v_v, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_X, __pyx_v_Y, __pyx_v_Z, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "interp.interp3d.interp3d.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "interp.interp3d.interp3d.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "interp.interp3d.interp3d.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "interp.interp3d.interp3d._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_interp3D", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6interp_8interp3d_8interp3d_1_interp3D, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("_interp3D", (void (*)(void))__pyx_f_6interp_8interp3d_8interp3d__interp3D, "__pyx_t_5numpy_float_t (__Pyx_memviewslice, __pyx_t_5numpy_float_t, __pyx_t_5numpy_float_t, __pyx_t_5numpy_float_t, int, int, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_interp__interp3d__interp3d) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "interp.interp3d.interp3d")) {
      if (unlikely(PyDict_SetItemString(modules, "interp.interp3d.interp3d", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "interp/interp3d/interp3d.pyx":2
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "interp/interp3d/interp3d.pyx":1
 * cimport numpy as np             # <<<<<<<<<<<<<<
 * import numpy as np
 * from libc.math cimport floor
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init interp.interp3d.interp3d", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init interp.interp3d.interp3d");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
